...
public class Quiz_Login_display extends Quiz_TimeService{
	...
	public void memberExit() {
		if (d.getId() == null && d.getPwd() == null) {
			...
			endSet();
			System.out.println("사용 시작 : " + startcheck());
			System.out.println("사용 종료 : " + endcheck());
			System.out.println("총 사용 시간 : " + useTime());
		}
	}
